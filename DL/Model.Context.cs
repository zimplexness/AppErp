...
namespace DL
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual DbSet<MaxAliRetencion> MaxAliRetencion { get; set; }
        public virtual DbSet<MantenimientoVehiculos> MantenimientoVehiculos { get; set; }
        public virtual DbSet<RegistrosConducir> RegistrosConducir { get; set; }
        ...
        public virtual int GetRetencionesByOrdenPago(Nullable<int> idPago)
        {
            var idPagoParameter = idPago.HasValue ?
                new ObjectParameter("IdPago", idPago) :
                new ObjectParameter("IdPago", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetRetencionesByOrdenPago", idPagoParameter);
        }
        ...
        public virtual ObjectResult<Nullable<double>> CalcularImporteNeto(Nullable<int> idComprobante)
        {
            var idComprobanteParameter = idComprobante.HasValue ?
                new ObjectParameter("IdComprobante", idComprobante) :
                new ObjectParameter("IdComprobante", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<double>>("CalcularImporteNeto", idComprobanteParameter);
        }
    
        public virtual ObjectResult<SeleccionarDatosRetencion_Result> SeleccionarDatosRetencion(Nullable<int> idpago)
        {
            var idpagoParameter = idpago.HasValue ?
                new ObjectParameter("idpago", idpago) :
                new ObjectParameter("idpago", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SeleccionarDatosRetencion_Result>("SeleccionarDatosRetencion", idpagoParameter);
        }
        ...
        public virtual ObjectResult<SelectPagosProveedores_Result> SelectPagosProveedores(Nullable<System.DateTime> fechainicio, Nullable<System.DateTime> fechafin)
        {
            var fechainicioParameter = fechainicio.HasValue ?
                new ObjectParameter("fechainicio", fechainicio) :
                new ObjectParameter("fechainicio", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectPagosProveedores_Result>("SelectPagosProveedores", fechainicioParameter, fechafinParameter);
        }
    
        public virtual ObjectResult<GetAllComprobantesxFechas_Result> GetAllComprobantesxFechas(Nullable<System.DateTime> fechainicio, Nullable<System.DateTime> fechafin)
        {
            var fechainicioParameter = fechainicio.HasValue ?
                new ObjectParameter("fechainicio", fechainicio) :
                new ObjectParameter("fechainicio", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetAllComprobantesxFechas_Result>("GetAllComprobantesxFechas", fechainicioParameter, fechafinParameter);
        }
    }
}
