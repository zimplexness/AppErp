...
namespace Controllers
{
    public class EmpleadosController
    {
        ...
        public EmpleadosController() { empleado = new Empleados(); }
        ...
        public void ActivarEmpleado(string cuil) {
            using (Context=new Entities())
            {

                var empleado = Context.Empleados.Where(e => e.CUIL == cuil).FirstOrDefault();
        ...
        public int validarEmpleado(string cuil)
        {
