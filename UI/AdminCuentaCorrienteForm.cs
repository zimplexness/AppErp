...
namespace ErpGestion
{
    public partial class AdminCuentaCorrienteForm : MetroFramework.Forms.MetroForm
    {
        ...
        {
            CuentaCorrienteForm CORRIENTE = new CuentaCorrienteForm();
            CORRIENTE.FormClosed += AdminCuentaCorrienteForm_FormClosed;
            CORRIENTE.ShowDialog();
        }

        private void AdminCuentaCorrienteForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            //bindingSourceCuenta.DataSource = new ProveedorManager().GetCuentasCorrientes();
            //bindingSourceCuenta.ResetBindings(true);
        }
        ...
        private void metroGridCuenta_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            CuentaCorrienteForm frmcuenta = new CuentaCorrienteForm();
            frmcuenta.Cuit = metroGridCuenta.CurrentRow.Cells["Cuit"].Value.ToString();
            frmcuenta.FormClosed += frmcuenta_FormClosed;
